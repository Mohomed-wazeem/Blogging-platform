...
{/* <main className="relative min-h-screen bg-gray-900 flex items-center justify-center">
  <div className="absolute inset-0 -z-10">
    <div
      className="absolute inset-0 bg-cover bg-center opacity-20 animate-fade-in-out"
      style={{
        backgroundImage: "url('/images/bnrimg3.jpg')", // Replace with your image
  ...
  <div className="text-center px-8 py-4">
    ...
    <p className="text-lg text-gray-300 mb-10 leading-relaxed drop-shadow">
      Discover inspiring stories, insightful posts, and in-depth articles.
      Search for content that resonates with you and start exploring! 
      Discover inspiring stories, insightful posts, and in-depth articles.
      Search for content that resonates with you and start exploring! 
    </p>
